...
import TableHeadWraper from "./TableHeadWraper";

const TableHead = ({ onFilterChange }: { onFilterChange: (value: string) => void }) => {
  ...
  return (
    <div>
      ...
      {/* Pass the onFilterChange function to TableHeadWraper */}
      <TableHeadWraper onFilterChange={onFilterChange} />
    </div>
  );
};

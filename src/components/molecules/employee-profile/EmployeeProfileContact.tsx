...
const EmployeeProfileContact: React.FC = () => {
  ...
  return (
    <>
      <CardTitle className="text-[#243045] font-semibold font-lg">Contact Details</CardTitle>
...
export default EmployeeProfileContact;

...
const ContactPerson: React.FC = () => {
  ...
  return (
    <>
      <CardTitle className="text-[#243045] font-semibold font-lg">Contact Person</CardTitle>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-3">
       ...
       <div className="relative mt-1 w-full border border-gray-300 rounded-lg px-4 pt-4 pb-2 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
          <Label
            htmlFor="hr"
            className="absolute -top-2 left-4 px-2 text-xs font-normal text-gray-500 bg-white"
          >
        ...
        {/* email */}
        <div className="relative w-full border border-gray-300 rounded-lg px-4 mt-1 pt-4 pb-2 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
          <Label
            htmlFor="email"
            className="absolute -top-2 left-4 px-2 text-xs font-normal text-gray-500 bg-white"
          >

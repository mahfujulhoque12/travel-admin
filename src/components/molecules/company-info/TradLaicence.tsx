...
const TradLaicence = () => {
  ...
  const handleFileUploadClick = () => {
    const fileInput = document.getElementById('trad-input');
    fileInput?.click();
  };
    ...
    <div>
      ...
      >
        ...
        <div className="flex mx-auto items-center justify-center flex-col py-12">
          ...
          <InputFile id="trad-input" type="file" onChange={handleFileChange} />
          <Span className="text-[#243045] py-1 lg:text-sm font-normal">
            Drag your files to start uploading
          </Span>
          <div className="flex items-center gap-3">
            <span className="w-[260px] h-[1px] bg-[#DCDCDC] block"></span>

  ...
  (
    ...
    return (
      <SliderPrimitive.Root
        ...
        {...props}
      >
        <SliderPrimitive.Track className="relative h-3 w-full grow overflow-hidden rounded-full bg-[#EAECF0]">
          <SliderPrimitive.Range className="absolute h-full bg-blue-gradient" />
